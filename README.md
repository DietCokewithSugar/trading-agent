...
- **前端**: React + Vite + [Ant Design 5](https://ant.design/)(深色/浅色双主题、默认深色、专业金融终端设计语言、中文界面、移动端自适应),净值曲线用 [lightweight-charts](https://github.com/tradingview/lightweight-charts),其余图表 Recharts(构建后由后端静态托管)。字体自托管(Inter / IBM Plex Mono)。配色遵循美股惯例:绿涨红跌
